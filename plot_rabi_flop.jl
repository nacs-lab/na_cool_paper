...
NaCsPlot.plot_survival_data(data_hot_x0, fmt="C3o", label="Hot")
grid()
xlim([0, 144])
ylim([0, 1])
title("X carrier")
...
plot_f1_thermal(f_rx, ts_rx_p1_hot, 2π / τ_hot_rx * meles_rx_p1, nbar_hot_rx,
                δΩ_rx, 0.956528, color="C3")
NaCsPlot.plot_survival_data(data_hot_xp1, fmt="C3o", label="Hot")
grid()
xlim([0, 280])
ylim([0, 1])
title("X heating")
...
NaCsPlot.plot_survival_data(data_hot_y0, fmt="C3o", label="Hot")
grid()
xlim([0, 105])
ylim([0, 1])
title("Y carrier")
...
plot_f1_thermal(f_ry, ts_ry_p1_hot, 2π / τ_hot_ry * meles_ry_p1, nbar_hot_ry,
                δΩ_ry, 0.97323, color="C3")
NaCsPlot.plot_survival_data(data_hot_yp1, fmt="C3o", label="Hot")
grid()
xlim([0, 190])
ylim([0, 1])
title("Y heating")
...
NaCsPlot.plot_survival_data(data_hot_z0, fmt="C3o", label="Hot")
grid()
xlim([0, 285])
ylim([0, 1])
title("Z carrier")
...
plot_f1(f_az, ts_az_p1, 2π / τ_az * (meles_az_p1[1:3] * meles_ry_0[1:3]'),
        p_az * p_ry', 0, offsetΩ=0, color="C2", ls="-.")
...
NaCsPlot.plot_survival_data(data_hot_zp1, fmt="C3o", label="Hot")
grid()
xlim([0, 520])
ylim([0, 1])
title("Z heating")
