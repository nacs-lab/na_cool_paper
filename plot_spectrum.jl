...
# Radial x
# Without cooling
NaCsPlot.plot_survival_data(data_hot_rx, fmt="C3.-", label="\$x\$ initial")
# With cooling
NaCsPlot.plot_survival_data(data_cold_rx[1], fmt="C0.-", label="\$x\$ cooled")
NaCsPlot.plot_survival_data(data_cold_rx[2], fmt="C0.-")
NaCsPlot.plot_survival_data(data_cold_rx[3], fmt="C0.-")
grid()
text(-670, 0.84, "(A)")
ylim([0, 1])
xlim([-700, 1400])
...
# Without cooling
NaCsPlot.plot_survival_data(data_hot_ry, fmt="C3.-", label="\$y\$ initial")
# With cooling
NaCsPlot.plot_survival_data(data_cold_ry[1], fmt="C0.-", label="\$y\$ cooled")
NaCsPlot.plot_survival_data(data_cold_ry[2], fmt="C0.-")
NaCsPlot.plot_survival_data(data_cold_ry[3], fmt="C0.-")
grid()
text(-670, 0.84, "(B)")
ylim([0, 1])
xlim([-700, 1400])
...
fig = figure(figsize=[1.6, 1] * 4.8)
# Without cooling
NaCsPlot.plot_survival_data(data_hot_az, fmt="C3.-", label="\$z\$ initial")

# With cooling
NaCsPlot.plot_survival_data(data_cold_az[1], fmt="C0.-", label="\$z\$ cooled")
NaCsPlot.plot_survival_data(data_cold_az[2], fmt="C0.-")
NaCsPlot.plot_survival_data(data_cold_az[3], fmt="C0.-")
NaCsPlot.plot_survival_data(data_cold_az[4], fmt="C0.-")
NaCsPlot.plot_survival_data(data_cold_az[5], fmt="C0.-")
NaCsPlot.plot_survival_data(data_cold_az[6], fmt="C0.-")
NaCsPlot.plot_survival_data(data_cold_az[7], fmt="C0.-")
grid()
ylim([0, 1])
xlim([-145, 470])
legend()
