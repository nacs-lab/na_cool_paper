...
# Radial 3
plot_data(data_nocool_r3[1], 1, fmt="C1o-", label="Ax 3 before")
...
# With cooling
# Radial 2
plot_data(data_cool_r2[1], 1, fmt="C2v-", label="Ax 2 after")
plot_data(data_cool_r2[2], 1, fmt="C2v-")
plot_data(data_cool_r2[3], 1, fmt="C2v-")
# Radial 3
