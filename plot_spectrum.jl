...
# Radial 3
plot_data(data_nocool_r3[1], 1, fmt="C1o-", label="Axis 3")
plot_data(data_nocool_r3[2], 1, fmt="C1o-")
plot_data(data_nocool_r3[3], 1, fmt="C1o-")
...
# Radial 2
plot_data(data_cool_r2[1], 1, fmt="C2o-")
plot_data(data_cool_r2[2], 1, fmt="C2o-")
plot_data(data_cool_r2[3], 1, fmt="C2o-")
# Radial 3
plot_data(data_cool_r3[1], 1, fmt="C0o-")
plot_data(data_cool_r3[2], 1, fmt="C0o-")
plot_data(data_cool_r3[3], 1, fmt="C0o-")
...
plot_data(data_cool_a1_hi, 1, fmt="C0o-")
grid()
# ylim([0, 0.59])
# xlim([-100, 620])
# text(-50, 0.5, "(B)")
