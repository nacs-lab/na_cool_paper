...
# Radial x
# Without cooling
NaCsPlot.plot_survival_data(data_hot_rx, fmt="C3o-", label="\$x\$ initial", markersize=1)
# With cooling
NaCsPlot.plot_survival_data(data_cold_rx[1], fmt="C0s-", label="\$x\$ cooled", markersize=1)
NaCsPlot.plot_survival_data(data_cold_rx[2], fmt="C0s-", markersize=1)
NaCsPlot.plot_survival_data(data_cold_rx[3], fmt="C0s-", markersize=1)
...
# Without cooling
NaCsPlot.plot_survival_data(data_hot_ry, fmt="C3o-", label="\$y\$ initial", markersize=1)
# With cooling
NaCsPlot.plot_survival_data(data_cold_ry[1], fmt="C0s-", label="\$y\$ cooled", markersize=1)
NaCsPlot.plot_survival_data(data_cold_ry[2], fmt="C0s-", markersize=1)
NaCsPlot.plot_survival_data(data_cold_ry[3], fmt="C0s-", markersize=1)
axhline(0.96, c="#99aaaa", ls="-.")
grid()
text(-670, 0.84, "(B)")
ylim([0, 1])
...
fig = figure(figsize=[1.6, 1] * 4.8)
# Without cooling
NaCsPlot.plot_survival_data(data_hot_az, fmt="C3o-", label="\$z\$ initial", markersize=1)

# With cooling
NaCsPlot.plot_survival_data(data_cold_az[1], fmt="C0s-", label="\$z\$ cooled", markersize=1)
NaCsPlot.plot_survival_data(data_cold_az[2], fmt="C0s-", markersize=1)
NaCsPlot.plot_survival_data(data_cold_az[3], fmt="C0s-", markersize=1)
NaCsPlot.plot_survival_data(data_cold_az[4], fmt="C0s-", markersize=1)
NaCsPlot.plot_survival_data(data_cold_az[5], fmt="C0s-", markersize=1)
NaCsPlot.plot_survival_data(data_cold_az[6], fmt="C0s-", markersize=1)
NaCsPlot.plot_survival_data(data_cold_az[7], fmt="C0s-", markersize=1)
axhline(0.96, c="#99aaaa", ls="-.")
grid()
ylim([0, 1])
xlim([-145, 470])
...
figure()
NaCsPlot.plot_survival_data(data_cold_rx[2], fmt="C0s-", label="\$x\$ initial")
NaCsPlot.plot_survival_data(data_cold_rx[3], fmt="C0s-")
grid()
ylim([0, 0.035])
xlim([250, 1400])
xlabel("\$\\delta\$, Detuning from carrier (kHz)")
ylabel("F=1 population fraction")
legend()
NaCsPlot.maybe_save("$(prefix)_zoom_cool_rx")

figure()
NaCsPlot.plot_survival_data(data_cold_ry[2], fmt="C0s-", label="\$y\$ initial")
NaCsPlot.plot_survival_data(data_cold_ry[3], fmt="C0s-")
grid()
ylim([0, 0.035])
xlim([250, 1400])
...
ylabel("F=1 population fraction")
legend()
NaCsPlot.maybe_save("$(prefix)_zoom_cool_ry")

fig = figure(figsize=[1.6, 1] * 4.8)
NaCsPlot.plot_survival_data(data_cold_az[3], fmt="C0s-", label="\$z\$ initial")
NaCsPlot.plot_survival_data(data_cold_az[4], fmt="C0s-")
NaCsPlot.plot_survival_data(data_cold_az[5], fmt="C0s-")
NaCsPlot.plot_survival_data(data_cold_az[6], fmt="C0s-")
NaCsPlot.plot_survival_data(data_cold_az[7], fmt="C0s-")
...
ylabel("F=1 population fraction")
legend()
NaCsPlot.maybe_save("$(prefix)_zoom_cool_az")
