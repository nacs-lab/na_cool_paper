...
\begin{tikzpicture}
  ...
  \begin{scope}[transform canvas={rotate={4}}]
    ...
    \path (3.33, 0) node[above,orange!80!black] {Raman F2};
  ...
  \begin{scope}[transform canvas={cm={1,-0.28,0,1,(0, 0)}}]
    ...
    \path (1.6, 0) node[below,cyan!20!blue!80!black] {OP};
    \path (-1.25, 0) node[above,orange!80!black] {Raman F2};
    \path (-1.6, 0) node[below,orange!80!black] {\textbf{(R1)}};

    \path (0, 1.5) node[left,red!80!black,align=center] {Raman F1\\\textbf{(R2)}};

    \path (0, -1.7) node[right,red!80!black,align=center] {Raman F1\\\textbf{(R4)}};
