...
\begin{abstract}
  ...
  we achieve a ground state population of $93.5(7)$\% after $100$ ms of cooling,
...
\begin{figure}[b]
  ...
  \caption{Optical pumping motional-state redistribution and Raman coupling for large LD parameters for the axial direction ($z$). The range plotted covers $95$\% of the initial thermal distribution.
    ...
    $n_{\textrm{init}}$. Due to photon-recoil and the large LD parameter, $\eta^{\textrm{OP}}_z=0.6$,
...
\begin{figure*}
  ...
  \caption{(A) Left to right: Radial Raman sideband spectrum of $\Delta n_y=1,\,\Delta n_x=1,\,\Delta n_x=-1,\,\Delta n_y=-1,\,\Delta n_x=-2,\,\Delta n_y=-2$ before and after Raman sideband cooling.
    ...
    The curves reach a maximum contrast of 85\% (horizontal dashed line)
    because 5\% of atoms are lost from one imaging step to the next,
    and 10\% of atoms are additionally lost during Raman cooling.
    The blue lines correspond to a 1D ground state probability of $93$\%
    after cooling (not including loss) and
