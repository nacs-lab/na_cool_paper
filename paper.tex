...
\begin{abstract}
  ...
  we achieved a ground state preparation fidelity of $??\%$ after a few hundred ms of cooling
...
Raman transitions are $\{\eta^R_{1},\eta^R_{2},\eta^R_{3}\} = \{???, 0.34, 0.29\}$. As shown in
