...
The tweezer is created by focussing a $700$ nm wavelength laser beam through an NA=$0.55$ objective to a waist with slight elliptical radii $\{w_{0,x},w_{0,y}\}\approx \{0.70,0.69\}\,\mu$m.
...
We expect and have verified with Monte-Carlo simulation
to enhance the ground state probability after RSC
by increasing the detuning of the Raman beams and
implementing better control of the magnetic field.
